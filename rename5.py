...
# CONFIGURATION
# ==========================================
INPUT_PATH = "certificates"             # Name of your folder OR .zip file
...
if __name__ == "__main__":
    ...
    output_zip_name = input("Enter the desired name for your final ZIP file (e.g., 'may_batch_results'): ").strip()
    ...
    try:
        ...
        # Now uses the flexible input prep function
